...
* [Home Assistant](https://github.com/home-assistant/core) ⭐ 90,702 | 🐛 3,602 | 🌐 Python | 📅 2026-09-18 Site: <https://home-assistant.io/>, Stars: 39187 Language: Python
* [Domoticz](https://github.com/domoticz/domoticz) ⭐ 3,807 | 🐛 24 | 🌐 C++ | 📅 2026-09-16 Site: <http://www.domoticz.com/>, Stars: 2831, Language: C++
* [Gladys](https://github.com/GladysProject/Gladys) ⭐ 3,196 | 🐛 55 | 🌐 JavaScript | 📅 2026-09-18 Site: <https://gladysproject.com/>, Stars: 1573, Language: JavaScript
...
* [Jeedom](https://github.com/jeedom/core) ⭐ 414 | 🐛 52 | 🌐 PHP | 📅 2026-09-18 Site: <https://www.jeedom.com/site/en/>, Stars: 327, Language: PHP
* [MajorDoMo](https://github.com/sergejey/majordomo) ⭐ 406 | 🐛 51 | 🌐 PHP | 📅 2026-09-10 Site: <http://majordomohome.com/>, Stars: 346, Language: PHP
...
* [FHEM](https://github.com/mhop/fhem-mirror) ⭐ 107 | 🐛 44 | 🌐 Perl | 📅 2026-09-18 Site: <https://fhem.de/>, Revisions: 23387, Language: Perl
* [openHAB](https://github.com/openhab) Site: <http://www.openhab.org/>, Stars: 3484, Language: Java

Related awesome lists:

* [Awesome Home Assistant](https://github.com/frenck/awesome-home-assistant) ⭐ 8,455 | 🐛 23 | 🌐 Python | 📅 2026-09-18
...
* [SmartThings open-source components](https://github.com/SmartThingsCommunity/SmartThingsPublic) ⭐ 2,659 | 🐛 2,507 | 🌐 Groovy | 📅 2023-07-18 Site: <http://docs.smartthings.com>, Forks: 27667, Language: Groovy
...
* [Leon-AI](https://getleon.ai/), code: <https://github.com/leon-ai/leon> ⭐ 17,520 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-17
...
* [Snips](https://www.snips.ai/), code: <https://github.com/snipsco/>
  * Some links point to <https://github.com/snipsco/snips-platform> , which isn't available.
    <https://github.com/snipsco/snips-issues/issues/25> ⚠️ Archived
...
* Grid Layouts
  * <https://github.com/haltu/muuri> ⭐ 10,947 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-25 - No jQuery dep, no item resize (7832 stars)
  * <https://github.com/ducksboard/gridster.js> ⭐ 5,970 | 🐛 370 | 🌐 JavaScript | 📅 2020-09-10 - The "default" solution, jQuery plugin (6188 stars)
...
* [ha-floorplan](https://github.com/pkozul/ha-floorplan) ⚠️ Archived - Floorplans for Home Assistant
